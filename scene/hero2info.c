...
Scene *hero2info_scene(int label)
{
    ...
    h2info *pDerivedObj = (h2info *)malloc(sizeof(h2info));
    Scene *pObj = New_Scene(label);
    pDerivedObj->background = al_load_bitmap("assets/image/hero2info.png");
    ...
    pObj->Update = hero2info_update;
    pObj->Draw = hero2info_draw;
    pObj->Destroy = hero2info_destroy;
    return pObj;
}
...
void hero2info_update(Scene *self)
{
    ...
    // }
    // return;
    h2info *Obj = ((h2info *)(self->pDerivedObj));
...
void hero2info_draw(Scene *self)
{
    ...
    h2info *gs = ((h2info *)(self->pDerivedObj));
